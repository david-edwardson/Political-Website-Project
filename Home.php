...
if(isset($_SESSION['login'])){
		...
		<div id="main">
			...
			<div class="section" id="corporation">
				...
				<img src="./images/7897894704_3d2c2a09e7_o.jpg"/>
				<!-- <iframe width=1066 height=600 src="https://www.youtube.com/embed/suNz7Wh1jSA" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe> -->
